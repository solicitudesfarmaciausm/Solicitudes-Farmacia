    ...
    return (<div className="flex flex-col justify-center items-center w-full">
        ...
        <div className=" flex-col w-[90%] md:w-[50%] items-center justify-center flex ">
            ...
            {!loading && !error && solicitud && (
                ...
                <select className="select rounded-2xl w-auto cursor-pointer" id="estado" name="estado">
                    <option hidden defaultValue>{solicitud.estado?.nombre ?? 'Seleccionar estado'}</option>
                ...
                <select className="select rounded-2xl w-auto cursor-pointer" id="asignadoA" name="asignadoA">
                    <option hidden defaultValue>{fullName(solicitud.personal_asignado) || 'Seleccionar administrador'}</option>
